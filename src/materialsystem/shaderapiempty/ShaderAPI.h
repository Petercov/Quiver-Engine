...
public:
    ...
    */
    ...
    /*
    Returns the amount of texture memory used for the specified texture memory type
    */
...
public:
    ...
    */
	...
	virtual void GetDXLevelDefaults(unsigned &max_dxlevel, unsigned &recommended_dxlevel)
	{
